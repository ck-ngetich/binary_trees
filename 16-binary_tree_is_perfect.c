...
/**
 * depth - function to returns the depth of a given node.
...
/**
 * get_leaf - function to returns a leaf of a binary tree.
...
/**
 * is_perfect_recursive - function to checks if a binary tree is perfect recursively.
